...
export function MyInformation() {
  return (
    <>
              ...
              <div className="relative flex flex-1 flex-col gap-6">
                ...
                <div className="space-y-6 flex-1 flex flex-col items-center justify-center">
                  <h3 className="pt-0.5 text-lg font-bold text-balance text-black md:text-4xl dark:text-white">
                    Passionate about distributed systems and backend craftsmanship.
                  </h3>
                  <h2 className="text-sm/[1.125rem] text-black md:text-base/[1.375rem] dark:text-neutral-400 [&_b]:md:font-semibold [&_strong]:md:font-semibold">
                    I thrive on architecting scalable microservices, optimizing performance, and solving complex
                    backend challenges — always building for reliability and efficiency.
                  </h2>
                </div>
      ...
      >
        ⭐ Backend Architecture ⭐ System Design ⭐ Microservices
      </VelocityScroll>
    </>
  )
}
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">
          Crafting robust, scalable architectures
        </p>
      </motion.div>
...
const KeySkills = () => {
  ...
  const skills = [
    {
      name: "Java",
      color: "rgb(254 202 202)", // Red/Orange-ish
      darkColor: "rgba(248, 113, 113, 0.2)",
    },
    {
      name: "Spring Boot",
      color: "rgb(220 252 231)", // Green
    ...
    {
      name: "REST APIs",
      color: "rgb(224 231 255)", // Indigo
      darkColor: "rgba(99, 102, 241, 0.2)",
    },
    {
      name: "AWS",
      color: "rgb(255 237 213)", // Orange
      darkColor: "rgba(251, 146, 60, 0.2)",
    },
    {
      name: "Docker & K8s",
