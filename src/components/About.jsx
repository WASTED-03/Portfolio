    ...
    <section id="about" ref={ref} className="section-padding bg-gray-50">
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h3 className="text-3xl font-display font-semibold text-gray-800 mb-6">
              My Story
            </h3>
          ...
          >
            ...
            <div className="mb-8">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 min-h-[60px]">
                <span className="text-primary-600 font-mono text-lg">
                  {displayedText}
                  <motion.span
